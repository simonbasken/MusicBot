...
#######################################################################################################################
    ...
    async def cmd_next_song(self, player, channel, author, permissions, leftover_args, song_url):
        """
        Usage:
            {command_prefix}next song_link
            {command_prefix}next text to search for
        Queues a song as the next song to be played.
        """
        ...
        if 'entries' in info:
            ...
            try:
                entry, position = await player.playlist.add_entry_at_front(song_url, channel=channel, author=author)
